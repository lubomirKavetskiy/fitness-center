...
type JsonDataType = AuthUser | Appointment | Training | Coaches;
...
export async function getAppointmentsByMonthYear(
  ...
  // filter data and gym into format expected by client
...
export async function getTrainings(): Promise<Training[]> {
  return getJSONfromFile<Training>(filenames.trainings);
}

export async function getCoaches(): Promise<Coaches[]> {
  return getJSONfromFile<Coaches>(filenames.coaches);
}
