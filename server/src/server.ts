...
import coachesRoutes from './route-methods/coaches';
import trainingRoutes from './route-methods/training';
...
app.get('/trainings', trainingRoutes.get);
app.get('/coaches', coachesRoutes.get);
/* *********** END: routes ********* */
